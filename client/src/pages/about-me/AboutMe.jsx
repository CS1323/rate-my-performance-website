              ...
              <div className="about-text">
                ...
                <p>
                  <Trans i18nKey="about.p4" ns="legal">
                    Find out more about my books at <a href="https://cadencekeys.com/" target="_blank" rel="noopener noreferrer" className="contact-email" onClick={() => gaEvent({ category: 'outbound', action: 'author_site_click' })}>cadencekeys.com</a>
                  </Trans>
                </p>
              </div>
            </div>
